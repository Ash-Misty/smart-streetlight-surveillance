...
class _DashboardPageState extends State<DashboardPage> {
  ...
  ImageProvider _getProfileImage() {
    if (_isUsingLocalImage && _profileImageFile != null) {
  ...
  /// ================= SIMPLE EDIT PROFILE (Name & Email only) =================
  ...
  /// ================= FULL EDIT PROFILE (All fields) =================
  void showFullEditProfileDialog() {
    nameController.text = name;
    emailController.text = email;
    phoneController.text = phone;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// DRAWER - PERFECTLY FIXED
      drawer: Drawer(
        backgroundColor: const Color(0xFF0A2A47),
        child: SafeArea(
          child: Column(
            children: [
              // Profile Header with Container Box for both profile picture and name
              Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    // Container box for profile picture and name together
                    Container(
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        color: const Color(0xFF22D3EE).withOpacity(0.1),
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    ListTile(
                      leading: const Icon(Icons.person, color: Color(0xFF22D3EE)),
                      title: const Text(
                        "Profile",
                        style: TextStyle(color: Colors.white),
                      ),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            /// PROFILE CARD - Simplified (Only Name, Email, and Profile Image)
            Container(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    onPressed: showSimpleEditDialog,
